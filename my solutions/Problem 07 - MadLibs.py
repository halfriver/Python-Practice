...
categories of words, and then prints out a story with the words that the user
inputted.
...
line.
- Tip: it's easiest to write out a quick story on a piece of paper or a text
file, and then go back through and see which words the user should be able to
change.
'''
