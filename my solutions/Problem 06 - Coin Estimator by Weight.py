...
(pennies, nickels, dimes, and quarters) in either grams or pounds.
...
# given per-coin weight (g), wrapper capacity, value, and name of each type
...
grams = False
pounds = False
while grams is False and pounds is False:
